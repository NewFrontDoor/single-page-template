...
const RegisterIndividualForm = ({ handleSubmit, pristine, reset, submitting, noYouthGroup, youthGroup, registeredGroups }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {noYouthGroup &&
        <p>We'd still love to have you at TYC.  Please contact us on Facebook or at email@ministry.net.au and we'll sort out a youth group for you to come to TYC with.</p>
      }
