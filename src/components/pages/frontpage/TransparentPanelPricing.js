...
import splash2 from '../../../images/backgrounds/black-and-white/buildingsbg.jpg'
      ...
      <div className="row">
        <div className="col-sm-6">
          <div className="white-bg">
            ...
            <p className="pddn-20-btm text-center"><Link to="/" className="btn btn-main-ghost">Register for TYC</Link></p>
          </div>
        </div>
        <div className="col-sm-6">
          <div className="white-bg">
            ...
            <p className=" pddn-20-btm text-center"><Link to="/" className="btn btn-main-ghost">Register As a Leader</Link></p>
          </div>
        </div>
      </div>
    </div>
