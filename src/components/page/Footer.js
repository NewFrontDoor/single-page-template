          ...
          <ul className="list-inline">
            <li>
              {isFrontPage ?
                ...
                <Link className="redLink" to="/#about-tyc">What Is TYC?</Link>
              }
            </li>
            <li>
              {isFrontPage ?
                ...
                <Link className="redLink" to="/#event-features">Highlights</Link>
              }
            </li>
            <li>
              {isFrontPage ?
                ...
                <Link className="redLink" to="/#speakers">Speakers</Link>
              }
            </li>
            <li>
              {isFrontPage ?
                ...
                <Link className="redLink" to="/#pricing">Register</Link>
              }
            </li>
            <li>
              {isFrontPage ?
                ...
                <Link className="redLink" to="/#location">Location</Link>
              }
            </li>
          </ul>
